<template>
    <span>
        <transition name="fade" @after-leave="doDestroy" appear>
...
export default {
    props: {
        trigger: {
            type: String,
            default: 'hover',
            validator: value => ['click', 'hover', 'no'].indexOf(value) > -1,
        },
        delayOnMouseOver: {
            type: Number,
            default: 10,
    ...
    mounted() {
        ...
        switch (this.trigger) {
            ...
            case 'no':
                on(document, 'click', this.handleDocumentClick)
                on(document, 'keyup', this.handleEscape)
                break
        }
    },
    ...
    methods: {
        ...
        destroyPopper() {
            ...
            off(document, 'keyup', this.handleEscape)
