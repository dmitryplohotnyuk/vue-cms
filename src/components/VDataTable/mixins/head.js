...
var _VCheckbox = require('vuetify/es5/components/VCheckbox')

var _VCheckbox2 = _interopRequireDefault(_VCheckbox)

var _VIcon = require('vuetify/es5/components/VIcon')
    ...
    methods: {
        ...
        genHeader: function genHeader(header, key) {
            ...
            return this.$createElement.apply(
                this,
                ['th'].concat(_toConsumableArray(this.genHeaderData(header, array, key)))
            )
        },
