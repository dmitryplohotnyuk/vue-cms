...
var _filterable = require('vuetify/es5/mixins/filterable')

var _filterable2 = _interopRequireDefault(_filterable)

var _themeable = require('vuetify/es5/mixins/themeable')

var _themeable2 = _interopRequireDefault(_themeable)

var _loadable = require('vuetify/es5/mixins/loadable')

var _loadable2 = _interopRequireDefault(_loadable)

var _helpers = require('vuetify/es5/util/helpers')

var _console = require('vuetify/es5/util/console')
...
export default {
    ...
    computed: {
        ...
        computedRowsPerPageItems: function computedRowsPerPageItems() {
            ...
            return this.rowsPerPageItems.map(function(item) {
                return (0, _helpers.isObject)(item)
                    ? Object.assign({}, item, {
                          text: _this.$vuetify.t(item.text),
                      })
                    : {
                          value: item,
                          text: Number(item).toLocaleString(_this.$vuetify.lang.current),
                      }
            })
        },
        ...
        everyItem: function everyItem() {
            ...
            return (
                ...
                this.filteredItems.every(function(i) {
    ...
    methods: {
        ...
        filteredItemsImpl: function filteredItemsImpl() {
            ...
            if (this.hasSearch) {
                for (
                    var _len = arguments.length, additionalFilterArgs = Array(_len), _key = 0;
                    _key < _len;
                    _key++
                ) {
                ...
                items = this.customFilter.apply(
                    this,
                    [items, this.search, this.filter].concat(
                        _toConsumableArray(additionalFilterArgs)
                    )
                )
            ...
            return this.hideActions && !this.hasPagination
                ? items
        ...
        toggle: function toggle(value) {
            ...
            for (var index = 0; index < this.filteredItems.length; index++) {
                var key = (0, _helpers.getObjectValueByPath)(
        ...
        createProps: function createProps(item, index) {
            ...
            Object.defineProperty(props, 'selected', {
                ...
                set: function set(value) {
                    if (itemKey == null) {
                        ;(0, _console.consoleWarn)(
                            '"' + keyProp + '" attribute must be defined for item',
                            _this7
                        )
                    }
                ...
                set: function set(value) {
                    ...
                    if (!_this7.expand) {
                        for (var key in _this7.expanded) {
                            _this7.expanded.hasOwnProperty(key) &&
                                _this7.$set(_this7.expanded, key, false)
                        }
                    }
        ...
        genPagination: function genPagination() {
            ...
            if (this.itemsLength) {
                ...
                pagination = this.$scopedSlots.pageText
                    ...
                    : (_$vuetify = this.$vuetify).t.apply(
                          _$vuetify,
                          ['$vuetify.dataIterator.pageText'].concat(
                              _toConsumableArray(
                                  [this.pageStart + 1, stop, this.itemsLength].map(function(n) {
