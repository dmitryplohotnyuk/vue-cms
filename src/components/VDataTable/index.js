...
var _foot = require('vuetify/es5/components/VDataTable/mixins/foot')
var _foot2 = _interopRequireDefault(_foot)

var _progress = require('vuetify/es5/components/VDataTable/mixins/progress')
...
export default {
            ...
            default: function _default(items, search, filter, headers) {
                ...
                return items.filter(function(item) {
                    return props.some(function(prop) {
                        return filter(
                            (0, _helpers.getObjectValueByPath)(item, prop, item[prop]),
                            search
                        )
                    })
                })
    ...
    created: function created() {
        ...
        this.defaultPagination.sortBy =
            !this.disableInitialSort && firstSortable ? firstSortable.value : null
        this.initPagination()
    },
